# Skill: Connect to the Editor/Neovim MCP
...
## Integration with File Opening Protocol

After connecting, the `using-neovim` skill provides the **File Opening Protocol**:
